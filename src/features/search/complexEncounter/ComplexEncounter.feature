Feature: Complex encounter

Scenario: Is able to submit a complex encounter with offence and notices
        ...
        Then I wait on element "#currentEncounter_pagetitle" to be displayed
        Then I click on the button with the text "Driver 2"
        Then I wait on element "smc-general::db-spinner" to not be displayed
        Then I wait on element "#driverDetails_pagetitle" to be displayed
        When I click on the element "#driverDetailsDateOfBirthPicker button"
        When I set "14/10/1995" to the ionic 3 date field "#driverDetailsDateOfBirthPicker"
        Then I click on the button with the text "Done"
        When I fill in the mandatory driver 2 details from a datatable
             | ethnicity            | W1 - BRITISH |
             | firstName            | Mark         |
             | lastName             | Doe          |
             | resident             | No           |
        ...
        Then I fill in the mandatory offences with offencegroup from a datatable
            ...
            | offenceGroup   | DOCUMENTS                          |
            | offence        | EC-FTP & INSP/COPY ANY DOCS-11HR   |
        When I click on the element "#driverName_0"
        Then I fill in the mandatory offences with offencegroup from a datatable
        ...
        # fill 'Driver 2' Offences
        When I click on the element "#driverName_1"
        Then I fill in the mandatory offences from a datatable
            | offenceType    | FIXED PENALTY DEFECT     |
            | offenceSubType | BRAKES                   |
        ...
        When I click on the element "#addDriver_1_Offence_0"
        Then I wait on element "smc-general::db-spinner" to not be displayed
        ...
        And I click on the button with the text "Continue Encounter"
        And I click on the button with the text "Leave"
        ...
        Then I wait on element "smc-general::db-spinner" to not be displayed
        And I set "Abc" to the inputfield "smc-additional-information::additional-text"
        # And I click on the element "smc-additional-information::save-data-button"
        And I pause for 5000ms
        # And I click on the button with the text "Save Data"
