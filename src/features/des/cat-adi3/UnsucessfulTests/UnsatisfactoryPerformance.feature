Feature: Cat-ADI3 Successful feature
  ...
  Scenario: Unsuccessful ADI3 test with Unsatisfactory Performance
    ...
    And I wait on element "des-waiting-room-to-car::vehicle-registration-input-input" to be displayed
    ...
    And I wait on element "des-test-report-screen::adi-dashboard-lesson-and-theme-card-heading" to be displayed
    ...
    And I wait on element "des-test-report-screen::adi-dashboard-test-report-card-heading" to be displayed
    And I click on the element "des-test-report-screen::adi-dashboard-test-report-card-heading"
    And I wait on element "des-adi-test-report-screen::lesson-planning-label" to be displayed
    ...
    And I score 0 for the 3rd question for section "Teaching & learning strategies"
    ...
    And the element "des-adi-test-report-screen::total-score-value" matches the text "30"
    And I click on the element "des-adi-test-report-screen::continue-button"
    And I wait on element "des-test-report-screen::adi-review-card-feedback-textarea" to be displayed
    And I click on the element "des-test-report-screen::adi-review-card-feedback-textarea"
    And I input the letter "m" into adi3 review textbox
    ...
    And the element "des-test-report-screen::modal-teaching-and-learning-score" matches the text "15"
    And the element "des-test-report-screen::modal-overall-score" matches the text "30"
    ...
    And I wait on element "des-office-page::additional-information-textarea" to be displayed
    ...
    And I expect that element "des-my-journal::journal-loading-spinner" is not displayed
    And I wait on element "#activity-code-23123428" to be displayed
