Feature: Cat-G Home Successful feature
  ...
  Scenario:   Successful Cat-G Home with no faults
    ...
    And I start the test for "#start-test-button-22123414"
    ...
    And I expect that element "des-my-journal::journal-loading-spinner" is not displayed
    And I scroll to element "#activity-code-22123414"
    And I expect that element "#activity-code-22123414" matches the text "1"
