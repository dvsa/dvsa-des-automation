Feature: Cat-CM Successful feature
  ...
  Scenario:   Check validation on all pages
    ...
    And I wait on element "des-test-report-screen::legal-requirements-modal-manoeuvres-list" to be displayed
    ...
    And I expect that element "des-my-journal::journal-loading-spinner" is not displayed
    And I expect the activity code "55512302" matches the text "1"
