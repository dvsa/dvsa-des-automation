...
@test
  Scenario:   Unsuccessful Test with Serious faults
...
#    And I wait on element "des-test-report-screen::page-title" to be displayed
#    And I select all legal requirements
##    And I click and hold on the element "des-test-report-screen::competency-btn-accelarator" for "1000"ms
#    And I add a dangerous fault to the "<string>" field
#    And I expect that element "des-dashboard::staff-number" matches the text "1234567"
