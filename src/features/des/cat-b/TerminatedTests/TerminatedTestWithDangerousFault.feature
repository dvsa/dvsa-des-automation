Feature: Cat-B Terminated With Dangerous fault

  Scenario: Terminated test with 1 dangerous fault
    ...
    And I click on the button "des-test-report-screen::terminate-test-btn"
    ...
    And I expect that element "#activity-code-20654334" contains the text "4"
