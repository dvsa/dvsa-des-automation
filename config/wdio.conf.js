...
const addCommands_1 = __importDefault(require("../shared/custom/support/lib/addCommands"));
...
exports.config = {
    ...
    outputDir: path_1.default.join('./reports/logs'),
    //
    ...
    before: async () => {
        await addCommands_1.default.addCommands();
    },
};
